...
const QuizzesContainer = () => {
  ...
  useEffect(() => {
    ...
    filterOptions.maxTime,
    filterOptions.minTime,
    transformedQuizzes.length,
    filters.timeRange,
  ]);
  ...
  const filteredQuizzes = useMemo(() => {
    return transformedQuizzes.filter((quiz) => {
      ...
      return (
        matchesSearch && matchesDifficulty && matchesTimeRange && matchesTopics
      );
    });
