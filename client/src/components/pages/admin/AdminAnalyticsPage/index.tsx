      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center space-y-4 md:space-y-0">
        <div>
          ...
          <p className="text-gray-500 dark:text-gray-400">
            Track performance and feedback analysis
          </p>
        </div>
      </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6">
          <div className="flex items-center justify-between mb-6">
            ...
            <button
              ...
              className="text-purple-600 dark:text-purple-400 text-sm font-medium cursor-pointer"
            >
              {showAllFeedback ? "Show less" : "View All"}
            </button>
          </div>
          <div
            className={`space-y-4 ${showAllFeedback ? "max-h-96 overflow-y-auto pr-2" : ""}`}
          >
