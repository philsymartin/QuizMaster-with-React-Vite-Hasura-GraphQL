...
import { GET_QUIZZES } from '../../../api/queries/quizzes'; // Import your query
import QuizDetailsPanel from '../../components/adminQuizPanel/AdminQuizDetailsPanel';
...
const AdminQuizManagementPage = () => {
    ...
    const filteredQuizzes = data?.quizzes.filter((quiz: Quiz) => {
                        ...
                        <thead className="bg-gray-50 dark:bg-gray-700">
                            <tr>
                                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 
                                           dark:text-gray-400 uppercase tracking-wider">Quiz Info</th>
                                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 
                                           dark:text-gray-400 uppercase tracking-wider">Difficulty</th>
                                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 
                                           dark:text-gray-400 uppercase tracking-wider">Questions</th>
                                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 
                                           dark:text-gray-400 uppercase tracking-wider">Time Limit</th>
                                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 
                                           dark:text-gray-400 uppercase tracking-wider">Stats</th>
                                ...
                                <tr key={quiz.quiz_id}>
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap">
                                        <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs 
                                                        font-medium ${getDifficultyColor(quiz.difficulty)}`}>
                                            {quiz.difficulty}
                                        </span>
                                    </td>
                                    ...
                                    <td className="px-6 py-4">
                                        ...
                                        <div className="text-sm text-gray-500 dark:text-gray-400">
                                            {quiz.average_rating.toFixed(1)} avg rating
                                        </div>
                                    </td>
