...
import { selectQuestions } from '../../../redux/quiz/quizSlice';
...
const QuestionsTab = ({ questions }: QuestionsTabProps) => {
    ...
    const handleAddQuestion = () => {
        // TODO: Add action creator for adding question
        // dispatch(addQuestion());
    };

    const handleEditQuestion = (questionId: number) => {
        // TODO: Add action creator for editing question
        // dispatch(editQuestion(questionId));
    };

    const handleDeleteQuestion = (questionId: number) => {
        // TODO: Add action creator for deleting question
