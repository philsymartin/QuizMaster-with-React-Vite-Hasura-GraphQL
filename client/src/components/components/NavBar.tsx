...
const NavBar: React.FC<NavBarProps> = ({ onToggleSidebar, isSidebarOpen }) => {
    ...
    const linkStyles = (path: string): string => `
        ...
        after:bg-purple-600 dark:after:bg-purple-400 after:scale-x-0 after:transition-transform
                ...
                <div className="relative" ref={dropdownRef}>
                    <button
                        ...
                        className="w-8 h-8 rounded-full bg-gradient-to-r from-purple-600 to-blue-500 
                                 ...
                                 transform hover:scale-105 transition-all focus:outline-none"
    ...
    return (
        <nav className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-md shadow-lg sticky top-0 z-50 transition-colors duration-200">
